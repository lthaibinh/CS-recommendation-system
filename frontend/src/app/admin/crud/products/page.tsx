...
export default function ProductsPage() {
  const [products] = useState<Product[]>([
    { id: 1, name: 'Apple iMac 27"', category: 'Electronics', price: 2999, stock: 45, status: 'active' },
    { id: 2, name: 'Apple iPhone 14', category: 'Electronics', price: 999, stock: 123, status: 'active' },
    { id: 3, name: 'Apple MacBook Pro', category: 'Electronics', price: 2499, stock: 67, status: 'active' },
    { id: 4, name: 'Magic Mouse', category: 'Accessories', price: 99, stock: 234, status: 'active' },
    { id: 5, name: 'AirPods Pro', category: 'Accessories', price: 249, stock: 189, status: 'active' },
  ]);
        ...
        <div className="items-center justify-between lg:flex">
          <div className="mb-4 lg:mb-0">
            ...
            <span className="text-base font-normal text-gray-500 dark:text-gray-400">
              Manage all your existing products or add new ones
            </span>
          </div>
            ...
            <tbody>
              {products.map((product) => (
                ...
                >
                  ...
                  >
                    <div className="w-10 h-10 bg-gray-200 rounded-lg dark:bg-gray-700 flex items-center justify-center">
                    ...
                    <div className="flex items-center">
                      <div
                        className={`h-2 w-2 rounded-full ${
                          product.stock > 100 ? 'bg-green-500' : 'bg-yellow-500'
                        } mr-2`}
                      ></div>
                      {product.stock}
                    </div>
